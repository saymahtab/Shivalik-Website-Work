...
const NewsEvents = () => {
  const events = [
    {
      image: '/assets/posters/poster1.png',
      title: 'Management Vibes',
      date: 'June 04',
      link: '#',
    },
    {
      image: '/assets/posters/poster2.png',
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {events.map((event, index) => (
            <div
              key={index}
              className="bg-white shadow-lg rounded-lg overflow-hidden transform transition-transform duration-300 ease-in-out hover:scale-110"
            >
